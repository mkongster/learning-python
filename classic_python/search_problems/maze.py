...
if __name__ == '__main__':
    ...
    solution_dfs: Optional[Node[MazeLocation]] = dfs(maze.start, maze.goal_test, maze.successors)
    ...
    solution_bfs: Optional[Node[MazeLocation]] = bfs(maze.start, maze.goal_test, maze.successors)
    if solution_bfs is None:
        print('No solution found using breadth-first search!')
    else:
        print('Solved maze using breadth-first search: ')
    ...
    solution_astar: Optional[Node[MazeLocation]] = astar(maze.start, maze.goal_test, maze.successors, distance)
    if solution_astar is None:
        print('No solution found using astar search!')
    else:
        path_astar: List[MazeLocation] = node_to_path(solution_astar)
